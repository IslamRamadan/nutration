...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <ul class="sidebar-menu pad-0">
            <!-- Optionally, you can add icons to the links -->
            <li class="moha"><a style="" href="{{ route('dashboard.index') }}"><i class="fa fa-home"></i>
                    <span> @lang('site.home')</span></a></li>
            ...
            @if (Auth::user()->job_id == 1)
                <li class="moha"><a style="" href="{{ route('sliders.index') }}"><i
                            class="fa fa-list"></i> <span> @lang('site.slider') </span></a></li>
                <li class="moha"><a style="" href="{{ route('social.index') }}"><i
                            class="fa fa-list"></i>
                        <span>@lang('site.social') </span></a></li>
                ...
                <li class="moha"><a style="" href="{{ route('sections.index') }}"><i
                            class="fa fa-list"></i> <span> @lang('site.sections') </span></a></li>
                <li class="moha"><a style="" href="{{ route('calories.calc') }}"><i
                            class="fa fa-list"></i> <span> @lang('site.calories_calc') </span></a></li>
                <li class="moha"><a style="" href="{{ route('nutrition.specialist') }}"><i
                ...
                <li class="moha"><a style="" href="{{ route('contact.index') }}"><i
                            class="fa fa-list"></i> <span>@lang('site.contacts_sec') </span></a></li>
                <li class="moha"><a style="" href="{{ route('users.index') }}"><i class="fa fa-users">
                        </i><span>@lang('site.managers') </span></a></li>
                <li class="moha"><a style="" href="{{ route('roles.index') }}"><i
                            class="fa fa-list"></i>
                        <span>@lang('site.manager_roles') </span></a></li>
                <li class="moha"><a style="" href="{{ route('profile.index') }}"><i
                            class="fa fa-user"></i> <span>@lang('site.profile') </span></a></li>
            @endif
