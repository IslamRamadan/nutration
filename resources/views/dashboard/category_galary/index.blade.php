            ...
            <table class="table table-hover table table-bordered">
                ...
                @foreach ($categories as $category)
                    ...
                    <tr>
                        ...
                        <td class="text-center"> <img style="width:150px;height:100px" src="{{asset($category->img)}}" alt=""></td>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{url(route("category_galaries.destroy",$category->id)) }}" method="post" style="display: inline-block">
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
