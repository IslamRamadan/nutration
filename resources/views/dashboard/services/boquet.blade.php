...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        <form action="{{ route('boquet_order') }}" method="get">
            ...
            <table class="table table-hover table-bordered  ">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center">@lang('site.bouquet')</th>
                ...
                <tbody>
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td class="text-center">{{ $service->boquet->title_ar }}</td>
                            @else
