...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        <form action="{{ route('calories.calc') }}" method="get">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered  ">
                ...
                <tr>
                    ...
                    <th class="text-center">@lang('وصف الوجبه(الكميات)')</th>
                ...
                @foreach ($services as $service)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{url(route("service.show",$service->id)) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.show')</a>


                    <form action="{{url(route("service.destroy",$service->id)) }}" method="post" style="display: inline-block">
                        {{ csrf_field() }}
                        {{ method_field('delete') }}
