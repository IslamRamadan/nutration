...
<div class="  " style="padding:10px">
    ...
    <a href="{{ route('works.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang("site.new")</a>
                ...
                @foreach ($works as $work)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{url(route("works.edit",$work->id)) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>


                            <form action="{{url(route("works.destroy",$work->id)) }}" method="post" style="display: inline-block">
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
