...
@section('mo')
     ...
     @section('ti')
   صور :   {{ App\Models\Item::find($id)->name??"" }}
     @endsection
  <div class="  " style="padding:10px">
    ...
    <div class="box-body">
        ...
        <div class="box-header with-border">
           {!! Form::model("", ['route' => ['galaries.store',$id],
                    ...
                    <table class="table table-hover table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td class="text-center"> <img style="width:150px;height:100px" src="{{asset($post->img)}}" alt="{{$post->title}}"></td>
                                ...
                                <form action="{{url(route("galaries.destroy",$post->id)) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
