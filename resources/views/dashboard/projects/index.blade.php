...
<div class="  " style="padding:10px">
    ...
    <a href="{{ route('projects.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang("site.new")</a>
                ...
                @foreach ($services as $service)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{url(route("projects.show",$service->id)) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.show')</a>


                            <form action="{{url(route("projects.destroy",$service->id)) }}" method="post" style="display: inline-block">
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
