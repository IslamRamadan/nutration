...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        {!! Form::model("", ['route' => ['categories.update.category',$category->id],
        ...
        <div class="form-group">
            ...
            {{$category->section1_en}}</textarea>
        </div>

        <div class="form-group">
            <label>@lang('site.section1_ar')</label>
            <textarea  name="section1_ar" class="form-control" >
            {{$category->section1_ar}}</textarea>
        </div>


        <div class="form-group">
            <label>@lang('site.section2_title_en')</label>
            <input type="text" name="section2_title_en" class="form-control" value="{{$category->section2_title_en}}">
        </div>

        <div class="form-group">
            <label>@lang('site.section2_title_ar')</label>
            <input type="text" name="section2_title_ar" class="form-control" value="{{$category->section2_title_ar}}">
